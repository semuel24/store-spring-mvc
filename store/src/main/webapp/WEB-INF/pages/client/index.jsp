						...
						<div class="carousel-inner">
							<div class="item active">
								<img class="img-responsive img-full"
									src="<c:url value="/resources/startbootstrap-business-casual/img/slide-1.jpg" />"
									alt="">
							</div>
							<div class="item">
								<img class="img-responsive img-full"
									src="<c:url value="/resources/startbootstrap-business-casual/img/slide-2.jpg" />"
									alt="">
							</div>
							<div class="item">
								<img class="img-responsive img-full"
									src="<c:url value="/resources/startbootstrap-business-casual/img/slide-3.jpg" />"
									alt="">
							</div>
						</div>
			...
			<div class="box">
				<div class="col-lg-12">
					...
					<img class="img-responsive img-border img-left"
						src="<c:url value="/resources/startbootstrap-business-casual/img/intro-pic.jpg" />"
						alt="">
					<hr class="visible-xs">
