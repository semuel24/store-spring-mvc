...
--
-- Table structure for table `freeserver`
--

DROP TABLE IF EXISTS `freeserver`;
...
--
-- Dumping data for table `freeserver`
--

LOCK TABLES `freeserver` WRITE;
/*!40000 ALTER TABLE `freeserver` DISABLE KEYS */;
/*!40000 ALTER TABLE `freeserver` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2014-12-17 22:09:39
